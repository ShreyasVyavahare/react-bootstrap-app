...
function SlabsDetails() {
    ...
    const product = abc.data[productId];

    if (!product) {
        return <div>Product not found</div>;
    }

    const { product_name, description, primary_colour, vein, category, image_url, image_url2, slider_img, slider_img2, slider_img3 } = product;
                ...
                <section className="productSection">
                    <div className="row" style={{ marginTop: '60px' }}>
                        ...
                        <div id="productPageDescriptionContainer" className="col-lg-6">
                            <h4 style={{ fontFamily: 'serif',margin:'10px' }} >{description}</h4>
                            <div className="BorderLine" ></div>

                            <div className="row">
                                <div className="col-lg-6">
                                    <div style={{ marginLeft: '30px', marginTop: '30px' }}>
                                        <h5 style={{ fontWeight: '1000', marginBottom: '20px' }}>Primary colour: </h5>
                                        <p>{primary_colour}</p>
                                        <h5 style={{ fontWeight: '1000', marginBottom: '20px' }}>Vein: </h5>
                                        <p>{vein}</p>
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <div style={{ marginLeft: '30px', marginTop: '30px' }}>
                                        <h5 style={{ fontWeight: '1000', marginBottom: '20px' }}>Category: </h5>
                                        <p>{category}</p>
